package com.example.inventroytracking.Utilis;
        ...
        try {
            ...
            if (wb != null) {
                ...
                for (int i = 1; i < rownum; i++) {
                    ...
                    if (row != null) {
                        for (int j = 0; j < colnum; j++) {
                            ...
                            if (j ==  0){
                                ...
                                stockItem.setBarcode(value.toString());
                            ...
                            if (j ==  1){
                                String key = "desc";
                                itemMap.put(key, value);
                                stockItem.setDescription(value.toString());
                            ...
                            if (j ==  2){
                                String key = "loc";
                                itemMap.put(key, value);
                                stockItem.setLocation(value.toString());
                            ...
                            if (j ==  3){
                                ...
                                stockItem.setShelf(value.toString());
                            ...
                            if (j ==  4){
                                ...
                                float convertedPrice =Float.parseFloat(valueString);
                                stockItem.setPrice(convertedPrice);
                            ...
                            if (j ==  5){
                                ...
                                float convertedQty =Float.parseFloat(valueString);
                                stockItem.setQty(convertedQty);
                    ...
                    StockDatabase.getStockDatabase(context.getApplicationContext()).stockDao().insertIem(stockItem);
